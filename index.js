const {
  ...
  const ownerNumber = ['923201713746']
...
const port = process.env.PORT || 9090;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('923201713746', '923286813475');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("923201713746")){
  if(isReact) return
  m.react("🦋")
   }
  //==========public react============//
